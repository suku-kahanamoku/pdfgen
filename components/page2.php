...
<div class="w-full min-h-[257mm] px-6 py-4 box-border bg-white [page-break-after:always] [break-after:page] overflow-visible flex flex-col gap-16">
    ...
    ?>
        <div class="[page-break-inside:avoid] [break-inside:avoid] flex flex-col gap-8">
            <div class="flex items-center gap-4 text-[#927355] font-lora text-xl border-b border-[#eee] pb-2.5">
            ...
            <div class="flex flex-col gap-6">
                ...
                ?>
                    <div class="flex items-center gap-4 [page-break-inside:avoid] [break-inside:avoid]">
                        <div class="rounded-full w-5 h-5 flex justify-center items-center flex-shrink-0 border"
                        ...
                        <div class="flex-1 bg-white border border-[#f0f0f0] rounded-xl px-4 py-3.5 flex gap-4 items-center">
                            <div class="bg-[#f8f8f8] px-3.5 py-2.5 rounded-lg min-w-36 flex-shrink-0 flex flex-col gap-0.5">
                                ...
                                <div class="text-[#777] font-bold uppercase tracking-[0.5px]"><?= htmlspecialchars($title) ?></div>
                            </div>
                            ...
                            <div class="flex flex-col gap-1.5 items-end w-32 flex-shrink-0">
    ...
    <div class="[page-break-inside:avoid] [break-inside:avoid] flex flex-col gap-6">
        <h2 class="font-lora text-2xl text-[#333] m-0">Bilance majetku</h2>
        <div class="flex gap-8 items-start">
            <!-- Bar chart -->
            <div class="flex-1 flex items-center justify-center">
                <canvas id="chart-bilance-p2" width="260" height="180"></canvas>
                <script>
